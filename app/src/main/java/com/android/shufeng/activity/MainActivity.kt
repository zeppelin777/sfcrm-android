...
import com.android.shufeng.bean.SocketBean
import com.android.shufeng.databinding.ActivityMainBinding
import com.android.shufeng.net.HttpRequest
import com.android.shufeng.net.NetResponseCallBack
import com.android.shufeng.service.WebSocketService
...
//                    }
                    ...
                    Constants.ACTION_SHOW_MSG -> {
                        activity.showTips(intent.getStringExtra("message"))
                    }
                }
